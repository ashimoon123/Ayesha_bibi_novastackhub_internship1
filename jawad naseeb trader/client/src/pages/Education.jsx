...
const Education = () => {
  ...
  const defaultCourses = [
    ...
    { _id: '4', title: 'Fundamental Analysis & On-Chain Metrics', category: 'Fundamental Analysis', difficulty: 'Intermediate', duration: '4 hrs', description: 'Evaluate project whitepapers, tokenomics, active addresses, and network security.', instructor: 'Jawad Naseeb' },
    { _id: '5', title: 'Smart Contracts & DeFi Architecture', category: 'Blockchain', difficulty: 'Advanced', duration: '5.5 hrs', description: 'Explore decentralized finance protocols, liquidity pools, and yield mechanics.', instructor: 'Jawad Naseeb' },
    { _id: '6', title: 'Forex & Global Macro Trading Basics', category: 'Forex Basics', difficulty: 'Beginner', duration: '3.5 hrs', description: 'Understand central banks, interest rate policies, and currency pair dynamics.', instructor: 'Jawad Naseeb' }
  ];
